                    ...
                    <div className="container-custom max-w-4xl">
                        <div className="prose prose-lg max-w-none">
                            <p className="lead text-xl text-secondary-700 mb-8">
                                These Terms of Service (&ldquo;Terms&rdquo;) govern your use of the {SITE_CONFIG.name} website and services. By accessing or using our services, you agree to be bound by these Terms.
                            </p>
                            ...
                            <p className="text-secondary-600 mb-6">
                                We reserve the right to modify these Terms at any time. Changes will be effective upon posting to our website with an updated &ldquo;Last Updated&rdquo; date. Your continued use of our services after changes constitutes acceptance of the modified Terms.
                            </p>
